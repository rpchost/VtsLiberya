Public Class Catadioptre_lateral
    ...
    Private Sub Button11_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button11.Click
        ...
        My.Forms.DefectPage.Label2.Text = Label3.Text
        My.Forms.DefectPage.Label4.Text = Label4.Text
        My.Forms.DefectPage.Label5.Text = Label9.Text.Replace("'", "''")
        DefectPage.Show()
       Me.Dispose()
    End Sub
    ...
    Private Sub Catadioptre_lateral_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
