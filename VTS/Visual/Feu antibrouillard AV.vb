Public Class Feu_antibrouillard_AV
    ...
    Private Sub Feu_antibrouillard_AV_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
