Public Class Carburateur__systeme_d_injection
    ...
    Private Sub Carburateur__systeme_d_injection_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
