Public Class Courroie_pompe_dassistance_de_direction
    ...
    Private Sub Courroie_pompe_dassistance_de_direction_Load(sender As Object, e As EventArgs) Handles MyBase.Load
