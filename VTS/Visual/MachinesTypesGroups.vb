Public Class MachinesTypesGroups
    ...
    Private Sub FillData()
        ...
        Dim reader As SqlClient.SqlDataReader = opExec.rdGetReader("select ID, MACH_TYP_GR As TYPE from MACHINES_TYP_GR")
        Try
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        Dim opExec As New connection
        opExec.ExecuteSqlCommand("Insert into MACHINES_TYP_GR (MACH_TYP_GR) values ('" & txtType.Text & "')")
        opExec.closeConnection()
    ...
    Private Sub DeleteSection(GrId As Integer)
        ...
        Dim opExec As New connection
        opExec.ExecuteSqlCommand("delete from MACHINES_TYP_GR where ID = " & GrId)
        opExec.closeConnection()
