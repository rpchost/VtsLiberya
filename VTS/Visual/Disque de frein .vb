Public Class Disque_de_frein
    ...
    Private Sub btnMauvaise_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMauvaise.Click
        'My.Forms.DefectPage.Label1.Text = Label1.Text
        My.Forms.DefectPage.Label3.Text = Label2.Text
        My.Forms.DefectPage.Label2.Text = Label3.Text
        My.Forms.DefectPage.Label4.Text = Label4.Text
    ...
    Private Sub Disque_de_frein_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
