Public Class Réservoir_de_carburant

    Private Sub Réservoir_de_carburant_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
