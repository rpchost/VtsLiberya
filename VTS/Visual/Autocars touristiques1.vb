Public Class Autocars_touristiques1

    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        'My.Forms.DefectPage.Label1.Text = Label1.Text
        My.Forms.DefectPage.Label3.Text = Label10.Text
        My.Forms.DefectPage.Label2.Text = Label13.Text
    ...
    Private Sub Autocars_touristiques1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
