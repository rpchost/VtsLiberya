Public Class Feu_de_gabarit
    ...
    Private Sub btnDetImportanate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDetImportanate.Click
        'My.Forms.DefectPage.Label1.Text = Label1.Text
        My.Forms.DefectPage.Label3.Text = Label2.Text
        My.Forms.DefectPage.Label2.Text = Label3.Text
        My.Forms.DefectPage.Label4.Text = Label4.Text
    ...
    Private Sub Feu_de_gabarit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
